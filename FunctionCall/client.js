...
async function main() {
  ...
  const programId = new anchor.web3.PublicKey("AXEyv4kp7Y2x8MHc5nVywSPZcNSoUaUknj8yB3JE12oE");
  const owner = new anchor.web3.PublicKey("6JxLdTweYt6cb6UeyCiqkPCVTo4RBxswfoQwHWe5aHzY");
  const tokenaccount = new anchor.web3.PublicKey("7Nr5hhvKgVhzLLmKb74J91KLNPvKxqXJXfWHw23pMDr9");
